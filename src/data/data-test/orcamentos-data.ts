...
export const orcamentosData:TOrcamentosData = [
  ...
  },
  {
    ...
    gasto_material_obra: 40200,
    gasto_servico_obra: 15000,
    gasto_combustivel: 5000,
    gasto_alimentacao: 10000,
    data_emissao: new Date(Date.UTC(2024, 12, 20)),
    inicio_execucao: new Date(Date.UTC(2024, 11, 15)),
    previsao_termino: new Date(Date.UTC(2025, 4, 1)),
    situacaoObra: 'preparação',
    pdf_orcamento: '@/pdf/pdf1.pdf',
    pdf_contrato: '@/pdf/pdf2.pdf'
  },
  {
