...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2025 at 09:54 AM
...
ALTER TABLE `endereco_clientes`
  ...
  ADD KEY `fk2_enderecoClientes_usuarios` (`update_by`);
...
--
ALTER TABLE `endereco_clientes`
  ADD CONSTRAINT `fk2_enderecoClientes_usuarios` FOREIGN KEY (`update_by`) REFERENCES `usuarios` (`id`),
